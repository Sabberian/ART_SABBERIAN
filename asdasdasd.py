...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.btnt.setStyleSheet(
            "QPushButton {border-radius:6px; margin: 5px; background: black; color: white;} QPushButton:hover{border: 1px solid black; background: white; color:black;}")
        ...
        self.btnn.setStyleSheet(
            "QPushButton {border-radius:6px; margin: 5px; background: lightgrey; color: white;} QPushButton:hover{border: 1px solid black; background: white; color:black;}")
        ...
        self.btc.resize(0, 0)
        self.btc.move(210, 0)
        self.btc.setStyleSheet(
            "QPushButton {border-radius:6px; margin: 5px; background: black; color: white;} QPushButton:hover{border: 1px solid black; background: white; color:black;}")

        self.btc.clicked.connect(self.count)

        self.last_win_lbl = QLabel(self)
        self.last_win_lbl.setGeometry(300, 100, 200, 50)
        self.last_win_lbl.setText("                                                        ")
        self.last_win_lbl.move(300, 100)

        self.win1_lbl = QLabel(self)

        self.win1_lbl.setText(
            "кол-во побед первого игрока:{}                                      ".format(self.p1_win))
        self.win1_lbl.move(300, 165)

        self.win2_lbl = QLabel(self)

        self.win2_lbl.setText(
            "кол-во побед второго игрока:{}                                      ".format(self.p2_win))
        self.win2_lbl.move(300, 180)

        self.next_lbl = QLabel(self)

        self.next_lbl.setText('                                                                   ')
        self.next_lbl.move(0, 165)

        self.lblp1s = QLabel(self)
        self.lblp1s.setText("                                                               ")
        self.lblp1s.move(0, 260)

        self.lblp2s = QLabel(self)
        self.lblp2s.setText("                                                         ")
        self.lblp2s.move(0, 245)
    ...
    def end(self):
        if self.turn == 0:
            ...
            car = self.cards[a]
            self.next_lbl.setText("Следующая Карта: {} {}                                    ".format(car[1], car[0]))
    ...
    def count(self):
        ...
        self.winner = 0
        if self.p1score > 21 and self.p2score < 22:
            self.p2_win += 1
            self.btnz.setEnabled(False)
            self.btnk.setEnabled(False)
            self.last_win_lbl.setText("Выиграл 2 Игрок")
            self.last_win_lbl.setStyleSheet(
                "QLabel {color: green; background: lightgrey; font-size: 24px; border: 1px solid black; border-radius: 10px;} QLabel:hover{color: red; border-radius: 25px;}")
            self.winner = 2
        elif self.p2score > 21 and self.p1score < 22:
            self.p1_win += 1
            self.btnz.setEnabled(False)
            self.btnk.setEnabled(False)
            ...
            self.last_win_lbl.setStyleSheet(
                "QLabel {color: green; background: lightgrey; font-size: 24px; border: 1px solid black; border-radius: 10px;} QLabel:hover{color: red; border-radius: 25px;}")
            self.winner = 0
        elif self.p1score > self.p2score and self.p1score < 21:
            self.btnz.setEnabled(False)
            self.btnk.setEnabled(False)
            self.last_win_lbl.setText("Выиграл 1 Игрок")
            self.p1_win += 1
            self.last_win_lbl.setStyleSheet(
                "QLabel {color: green; background: lightgrey; font-size: 24px; border: 1px solid black; border-radius: 10px;} QLabel:hover{color: red; border-radius: 25px;}")
            self.winner = 1
        elif self.p1score < self.p2score and self.p2score < 22:
            self.p2_win += 1
            self.btnz.setEnabled(False)
            self.btnk.setEnabled(False)
            self.last_win_lbl.setText("Выиграл 2 Игрок")
            ...
            self.winner = 2
        if self.winner == 1:
            self.lblp1s.setStyleSheet("QLabel {color: green; background: lightblue; font-size: 12px;} ")
            self.lblp2s.setStyleSheet("QLabel {color: red; background: lightblue; font-size: 12px;} ")

        if self.winner == 2:
            self.lblp2s.setStyleSheet("QLabel {color: green; background: lightblue; font-size: 12px;} ")
            self.lblp1s.setStyleSheet("QLabel {color: red; background: lightblue; font-size: 12px;} ")

        if self.winner == 0:
            self.lblp2s.setStyleSheet("QLabel {color: black; background: yellow; font-size: 12px;}")
            self.lblp1s.setStyleSheet("QLabel {color: black; background: yellow; font-size: 12px;}")
        ...
        car = self.cards[a]
        self.next_lbl.setText("Следующая Карта: {} {}                                    ".format(car[1], car[0]))
        self.lblp1s.setText("Кол-во очков первого игрока:{}".format(self.p1score))
        self.lblp2s.setText("Кол-во очков торого игрока:{}".format(self.p2score))
    ...
    def again(self):
        ...
        self.btnz.resize(0, 0)
        self.next_lbl.setText("                                                                  ")
        self.last_win_lbl.setStyleSheet("QLabel {color: green; background: none; font-size: 12px;}")
        self.lblp2s.setStyleSheet("QLabel {color: black; background: none; font-size: 12px;}")
        self.lblp1s.setStyleSheet("QLabel {color: black; background: none; font-size: 12px;}")
        self.btnn.setStyleSheet(
            "QPushButton {border-radius:6px; margin: 5px; background: lightgrey; color: white;} QPushButton:hover{border: 1px solid black; background: white; color:black;}")
